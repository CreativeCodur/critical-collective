      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            <a href="https://www.nytimes.com" target="_blank" rel="noopener noreferrer" className="block bg-white p-8 rounded-lg shadow-sm transition hover:shadow-md">
              <img src="/The_New_York_Times_logo.png" alt="The New York Times" className="w-full h-16 object-contain" />
            </a>
          </div>
          <div className="text-center">
            <a href="https://www.newyorker.com" target="_blank" rel="noopener noreferrer" className="block bg-white p-8 rounded-lg shadow-sm transition hover:shadow-md">
              <img src="/The_New_Yorker-Logo.wine.svg" alt="The New Yorker" className="h-16 object-contain scale-[2.5] mx-auto" />
            </a>
          </div>
          <div className="text-center">
            <a href="https://www.npr.org" target="_blank" rel="noopener noreferrer" className="block bg-white p-8 rounded-lg shadow-sm transition hover:shadow-md">
              <img src="/NPR-Symbol.png" alt="NPR" className="h-16 object-contain scale-[2.5] mx-auto" />
            </a>
          </div>
        </div>
