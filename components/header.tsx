      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex items-center justify-between py-4">
          ...
          <Link href="/" className="flex items-center">
            <div className="rounded px-5 py-1 text-sm font-bold flex items-center gap-4 group" style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '1.25rem' }}>
              <img 
                src="/critical_institute_logo (1).jpeg" 
                alt="Critical Collective Logo" 
                className="transition-all hover:brightness-110 hover:hue-rotate-180"
